...
win32-msvc2008|win32-msvc2010 {
        ...
        CONFIG(release, debug|release) {
                ...
                # Copy Qt DLLs
                QMAKE_POST_LINK += $$quote(xcopy /D /Y "$$QTDIR_WIN\\plugins\\platforms\\qminimal.dll" "$$TARGETDIR_WIN\\release\\plugins\\platforms\\" /E /I $$escape_expand(\\n))
                QMAKE_POST_LINK += $$quote(xcopy /D /Y "$$QTDIR_WIN\\plugins\\platforms\\qwindows.dll" "$$TARGETDIR_WIN\\release\\plugins\\platforms\\" /E /I $$escape_expand(\\n))
